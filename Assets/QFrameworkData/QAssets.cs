...
namespace QAssetBundle
{
    ...
    public class Background_1_prefab
    {
        public const string BundleName = "background 1_prefab";
        public const string BACKGROUND_1 = "background 1";
    }
    public class Background_2_prefab
    {
        public const string BundleName = "background 2_prefab";
        public const string BACKGROUND_2 = "background 2";
    }
    public class Background_3_prefab
    {
        public const string BundleName = "background 3_prefab";
        public const string BACKGROUND_3 = "background 3";
    }
    public class Background_4_prefab
    {
        public const string BundleName = "background 4_prefab";
        public const string BACKGROUND_4 = "background 4";
    }
    public class Background_5_prefab
    {
        public const string BundleName = "background 5_prefab";
        public const string BACKGROUND_5 = "background 5";
    }
    public class C_png
    {
    ...
    public class Jump_prefab
    {
        public const string BundleName = "jump_prefab";
        public const string JUMP = "jump";
    }
    public class Land_prefab
    {
        public const string BundleName = "land_prefab";
    ...
    public class Scenetransition_prefab
    {
        public const string BundleName = "scenetransition_prefab";
    ...
    public class Uitransitionpanel_prefab
    {
        public const string BundleName = "uitransitionpanel_prefab";
        public const string UITRANSITIONPANEL = "uitransitionpanel";
    }
    public class White_prefab
    {
        public const string BundleName = "white_prefab";
